...
- 추천 리뷰 피드와 팔로우 리뷰 피드를 제공
- 다른 사람의 리뷰에 댓글과 답글을 달 수 있음
...
- Spring Security와 암호화를 사용하여 보안을 높이고, 로그인은 세션방식으로 구현
- 회원가입 시 아이디 중복 검사와 비밀번호 확인, 이메일로 인증번호를 받아 인증하기를 거쳐야 가입이 가능
