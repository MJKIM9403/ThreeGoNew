...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http
                .authorizeRequests()
                .requestMatchers("/test", "/search", "/bookmark/**","/review/**", "/book/**", "/mypage/**", "/checkDuplicateId","/checkDuplicateEmail", "/api/**", "/plan/**","planner/**","/login", "/join", "/user", "/error", "/index", "/info/**","/insertData", "/findId", "/findPw/**", "/delete").permitAll()
